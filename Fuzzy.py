...
def createContorller():
    ...
    error = fuzz.ctrl.Antecedent(universe, 'error')
    names = ['nb', 'ns', 'z', 'ps', 'pb']
    error.automf(names=names)

    delta = fuzz.ctrl.Antecedent(universe, 'delta')
    delta.automf(names=names)

    output = fuzz.ctrl.Consequent(universe, 'output')
    ...
    rule0 = fuzz.ctrl.Rule(antecedent=((error['nb'] & delta['nb']) |
                                  (error['ns'] & delta['nb']) |
                                  (error['nb'] & delta['ns']) |
                                  (error['z'] & delta['nb']) |
                                  (error['nb'] & delta['z'])),
    ...
    rule1 = fuzz.ctrl.Rule(antecedent=((error['ns'] & delta['ns']) |
                                  (error['ns'] & delta['z']) |
                                  (error['nb'] & delta['ps']) |
                                  (error['ps'] & delta['nb']) |
                                  (error['z'] & delta['ns'])),
    ...
    rule2 = fuzz.ctrl.Rule(antecedent=((error['z'] & delta['z']) |
                                  (error['ns'] & delta['ps']) |
                                  (error['nb'] & delta['pb']) |
                                  (error['ps'] & delta['ns']) |
                                  (error['pb'] & delta['nb'])),
    ...
    rule3 = fuzz.ctrl.Rule(antecedent=((error['ps'] & delta['ps']) |
                                  (error['ps'] & delta['z']) |
                                  (error['pb'] & delta['ns']) |
                                  (error['ns'] & delta['pb']) |
                                  (error['z'] & delta['ps'])),
    ...
    rule4 = fuzz.ctrl.Rule(antecedent=((error['pb'] & delta['pb']) |
                                  (error['ps'] & delta['pb']) |
                                  (error['pb'] & delta['ps']) |
                                  (error['z'] & delta['pb']) |
                                  (error['pb'] & delta['z'])),
    ...
    system = fuzz.ctrl.ControlSystem(rules=[rule0, rule1, rule2, rule3, rule4])
    controller = fuzz.ctrl.ControlSystemSimulation(system)
